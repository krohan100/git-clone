        ...
        while epoch_frame < info['EVAL_FREQUENCY']:
            ...
            while not terminal:
                ...
                if life_lost:
                    ...
                    eps,action,uncertainity_flag = action_getter.pt_get_action(step_number, state=state, active_head=active_head,uncertainity=get_uncertainity(state))
                ...
                if step_number % info['TARGET_UPDATE'] == 0 and step_number >  info['MIN_HISTORY_TO_LEARN']:
                    ...
                    average_plot(no_of_uncertainity_save,os.path.join(model_base_filedir, 'no_of_uncertainity'),'no_of_uncertainity')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--safe_model_loadpath', default='/home/chen-2/model_savedir/Pong_uncertainity00/Pong_uncertainity_0003508388q.pkl', help='.pkl model file full path')
    ...
    info = {
        ...
        "NAME":'pong_safe', # start files with name
